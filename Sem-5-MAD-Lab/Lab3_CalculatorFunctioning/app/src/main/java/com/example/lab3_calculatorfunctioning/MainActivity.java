package com.example.lab3_calculatorfunctioning;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Mapping Button Identifiers with their IDs
        ...
        //Mapping EditText Identifiers with their IDs
        ed1 = (EditText) findViewById(R.id.editText);


        //Button to EditText Functionality
        ButtonToEditText();
